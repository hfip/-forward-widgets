// ==========================================
// Module Name: Trakt Custom Lists 🎬
...
var WidgetMetadata = {
  id: "forward.dexworld.trakt.custom",
  title: "قوائمي الخاصة من Trakt 🔄",
  version: "1.2.0",
  requiredVersion: "0.0.1",
  description: "عرض قوائم الأنمي، المسلسلات، والأفلام الخاصة بي من Trakt مباشرة",
  author: "DexWorld",
  site: "https://t.me/plex_arab",
  modules: [
    { id: "tkAnimeList", title: "📺 قائمة الأنمي (My Anime)", functionName: "tkAnimeList", cacheDuration: 1800, params: [] },
    { id: "tkTvShowsList", title: "🎬 قائمة المسلسلات (My TV Shows)", functionName: "tkTvShowsList", cacheDuration: 1800, params: [] },
    { id: "tkMoviesList", title: "🎥 قائمة الأفلام (My Movies)", functionName: "tkMoviesList", cacheDuration: 1800, params: [] }
  ]
};
...
// القائمة الأولى: الأنمي الخاص بك
async function tkAnimeList() { 
  return await tkListByRef("halawi15", "my-anime"); 
}

// القائمة الثانية: المسلسلات الخاصة بك
async function tkTvShowsList() { 
  return await tkListByRef("halawi15", "my-tv-shows"); 
}

// القائمة الثالثة: الأفلام الخاصة بك
async function tkMoviesList() { 
  return await tkListByRef("halawi15", "my-movies"); 
}